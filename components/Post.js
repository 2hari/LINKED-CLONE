...
//the regular post and modal post version are both here nad that's why we have modalpost prop. 
function Post({ post, modalPost }) {
  ...
  return (
    ...
    >
      ...
      {/* next image is difficult to style */}
      ...
      <div className="flex justify-evenly items-center dark:border-t border-gray-600/80 mx-2.5 pt-2 text-black/60 dark:text-white/75">
        {modalPost ? (
          ...
          >
            {/* the like functionality is not persisted in database.  */}
            {liked ? (
